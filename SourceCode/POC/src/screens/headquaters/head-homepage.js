...
const HeadHomepage = () => {
  ...
  const [jobInfo, setJobInfo] = useState({ jobCode: "", jobName: "" });
      ...
      <div className="home-header">
        ...
        <div className="employee-info">
          ...
          <div className="profile-int">
            <h4>{branchInfo.branchCode || "N/A"}</h4>
          </div>
          <div>
            <h4>Branch Name:</h4>
          </div>
          <div className="profile-int">
            <h4>{branchInfo.branchName || "N/A"}</h4>
          </div>
          <div>
            <h4>Job Code:</h4>
          </div>
          <div className="profile-int">
            <h4>{jobInfo.jobCode || "N/A"}</h4>
          </div>
          <div>
            <h4>Job Name:</h4>
          </div>
          <div className="profile-int">
            <h4>{jobInfo.jobName || "N/A"}</h4>
          </div>
          <div>
            <h4>Logged in as:</h4>
          </div>
      ...
      <div className="home-content-box">
        ...
        <div className="button-container">
          <button
            ...
            onClick={() => navigate("/hqselect-question")}
          >
